iPWO CEC2017 D=10 performance evaluation and visualization -- reproducible package
================================================

1. Content
  code/     MATLAB reproducible code
    main30a.m                    Full test entry: run iPWO (MaxFEs=10000*D, 30 independent runs,
                                 D=10, F1+F3~F30 , 29 functions), and output raw results and reproduction data
  ...
  data/
    raw/                 29 raw result files CEC2017_F*_Dim10_iPWO_Results.mat
    ...
    iPWO_Dim10_Summary.csv  29 functions' best scores and final value of the average curve summary

  figures/              Single-panel TIFF (2.928 cm square, 600 DPI, 692x692 px, Times New Roman)
    F*_Dim10_1_3D_Landscape.tif ... F*_Dim10_5_Search_History.tif   individual panel subfigures (145 figures)
...
2. How to reproduce
  1) Full reproduction (from optimization, ~4-5 hours):
       cd code; main30a
     - Runs iPWO at the CEC2017 standard budget MaxFEs=10000*D, 30 times per function, D=10
