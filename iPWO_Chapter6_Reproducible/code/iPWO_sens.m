function [best_fitness, best_solution, Convergence_curve] = iPWO_sens(N, maxFES, lb, ub, dim, fobj, use_ECR, use_NAS, use_OED, use_rally, theta, rho)
% iPWO_abl - Improved Painted Wolf Optimization with ablation switches.
%
...
%             around the elite in the late stage.
    ...
    while FES + NP <= maxFES && iter < T
        ...
        if use_OED && mod(iter, ls_period) == 0 && FES + 2^K_oed <= maxFES
